...
public class TabbedMenuController
{
    ...
    private const string selectedContantClassName = "selectedContent";
    ...
    */
    ...
    private void SelectTab(Label tab)
    {
        ...
        content.AddToClassList(selectedContantClassName);
    }
    ...
    private void UnselectTab(Label tab)
    {
        ...
        content.RemoveFromClassList(selectedContantClassName);
    }
    ...
    public Label FindSelectedTab()
    {
        return (Label)root.Q(null, new string[] {currentlySelectedTabClassName});
    }

    public VisualElement FindSelectedTabContent()
    {
        return root.Q(null, new string[] {selectedContantClassName});
    }
}